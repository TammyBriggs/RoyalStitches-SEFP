...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
        ...
        <Link to='/'><img src={assets.logo} className='w-36' alt='Royal Stitches logo' /></Link>
        ...
        <Link to="/collection">
            ...
            <Link to='/cart' className='relative'>
                ...
                <p className='absolute right-[-5px] bottom-[-5px] w-4 text-center leading-4 bg-black text-white aspect-sqaure rounded-full text-[12px]'>{getCartCount()}</p>
            </Link>
